...
public class AuthenticationSettingsTest extends AbstractOtherSettingsTest {
    ...
    public void authenticationConfigurationCredentialReferenceAdd() throws Exception {
        ...
        crud.createSingleton(authenticationConfigurationAddress(AUT_CF_CR_CRT), form, formFragment -> formFragment.text("clear-text", clearText), resourceVerifier -> resourceVerifier.verifyAttribute("credential-reference.clear-text", clearText));
