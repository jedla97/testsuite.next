...
public class IIOPTest {
    ...
    public void updateInitializers() throws Exception {
        String authenticationContext = Random.name();
        ...
        crud.update(SUBSYSTEM_ADDRESS, form,
                f -> f.text(AUTHENTICATION_CONTEXT, authenticationContext),
                resourceVerifier -> resourceVerifier.verifyAttribute(AUTHENTICATION_CONTEXT, authenticationContext));
    }
